...
3 solutions implemented, as per the paper "[What you get is what you C: Controlling side effects in mainstream C compilers](https://drive.google.com/file/d/1jsOolD1C_Fu9oNVvhkB1_RQ9GlrFSGcN/view)". The code is a reference implementation, and is not supposed to be production ready. Nevertheless, 
